...
# STEP 3: Connection 으로부터 Cursor 생성
    ...
    def option_parsing(return_value):
    ...
    def optionlist_parsing(option_list, return_value):
        ...
        print(return_value[0] , return_value[2] , return_value[3], optionstr)
        ...
        DBClass.cur.execute(f"INSERT INTO platform_item VALUES('{return_value[2]}','{price}','{return_value[0]}','{r}','{k}','{None}','{return_value[3]}')")
        DBClass.con.commit()
